...
public class MainActivity extends AppCompatActivity {
     ...
     */
    public void showBundtOrder(View view) {
        showFoodOrder(getString(R.string.bundt_order_message));
    }

    /**
     * Shows a message that the ice cream sandwich image was clicked.
     */
    public void showCookieOrder(View view) {
        showFoodOrder(getString(R.string.cookie_order_message));
    }
